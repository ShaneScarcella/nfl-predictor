...
from nfl_app.utils import get_opponent_record_entering_week
...
def get_sos_analysis():
    ...
    if not team or not season or not week: return jsonify({'error': 'Missing parameters.'})
    ...
    if team_games.empty: return jsonify({'total_score': 0, 'breakdown': [], 'message': 'No past games found for this period.'})
    ...
    for _, game in team_games.iterrows():
        ...
        opp_record_info = get_opponent_record_entering_week(opponent, season, game['week'])
